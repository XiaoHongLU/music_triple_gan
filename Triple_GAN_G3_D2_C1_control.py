...
if not os.path.isfile(os.path.join(os.getcwd(), "Model/Triple_GAN_RNN_G3_D2_C1/Triple_GAN_RNN_G3_D2_C1.ckpt.meta")):
    with tf.Session(graph=graph) as session:
        tf.logging.set_verbosity(tf.logging.DEBUG)
        tf.global_variables_initializer().run()
        tf.local_variables_initializer().run()
        progress = open(os.path.join(os.getcwd(), 'Model/Triple_GAN_RNN_G3_D2_C1/Triple_GAN_RNN_G3_D2_C1.txt'), 'w')
        ...
        saver.save(session, os.path.join(os.getcwd(), "Model/Triple_GAN_RNN_G3_D2_C1/Triple_GAN_RNN_G3_D2_C1.ckpt"))
    ...
    with tf.Session(graph=graph) as session:
        ...
        saver.restore(session, os.path.join(os.getcwd(), 'Model/Triple_GAN_RNN_G3_D2_C1/Triple_GAN_RNN_G3_D2_C1.ckpt'))
